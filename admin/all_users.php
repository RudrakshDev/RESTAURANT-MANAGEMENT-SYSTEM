...
<script>
    function showAlert() {
      alert("Are You Sure You Want to Delete this Users?");
    }
  </script>
</head>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['address'].'</td>																								
																								<td>'.$rows['date'].'</td>
																									 <td style="text-align:center;"><a href="delete_users.php?user_del='.$rows['u_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10" onclick="showAlert();"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                        ...
                        <button class="btn btn-warning" style="background-color:#a4b4d3;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_all_users.php'">Export Data</button>
