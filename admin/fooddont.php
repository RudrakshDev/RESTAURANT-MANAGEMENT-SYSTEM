                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Food Donation Requests</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT * from fooddnt";
												$query=mysqli_query($db,$sql);
												
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="8"><center>No Food Donation Requests</center></td>';
														}
													else
														{				
																				...
																				<?php
                                                                                    ...
                                                                                    <td>".$rows["fd_id"]."</td>
																					           <td>".$rows["name"]."</td>
                                                                                                ...
                                                                                                <td><a href='redirect.php?photo=".$rows["imgname"]."' class='btn btn-primary'>".$rows["imgname"]."</a></td>"
																						...
																						<?php																									
																							...
																							?>
																									 <!-- <td>
																									 <a href="delete_orders.php?order_del= onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>  -->
																								<?php
                        ...
                        <button class="btn btn-warning" style="background-color:#a4b4d3;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_food_donation.php'">Export Data</button>
