...
<head>
    ...
    <title>All Advance Orders</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Advance Orders of All Restaurant</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql="SELECT users.*, adv_orders.*, restaurant.title AS restaurant_name 
                                                FROM users 
                        ...
                        <button class="btn btn-warning" style="background-color:#a4b4d3;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_all_adv_orders.php'">Export Data</button>
