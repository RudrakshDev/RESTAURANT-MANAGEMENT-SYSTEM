					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update restaurant set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',pass='$_POST[pass]',address='$_POST[address]',image='$fnew' where rs_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql); 
													mysqli_query($db, $sql); 
											...
											<div class="col-md-6">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="pass"  id="pass" value="<?php echo $row['pass'];  ?>" class="form-control form-control-danger">
                                                </div>
                                            </div>
