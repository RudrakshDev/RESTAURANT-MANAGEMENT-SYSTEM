            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
                                                                                                    ...
                                                                                                    <td style="text-align:center;"><a href="delete_restaurant.php?res_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> </td></tr>';
						...
						<button class="btn btn-warning" style="background-color:#a4b4d3;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_all_res.php'">Export Data</button>
