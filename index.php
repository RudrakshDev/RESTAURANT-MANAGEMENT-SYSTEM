    ...
    <!-- -- Nav Bar Starts here -->
    <centre>
            <header id="header" class="header-scroll top-header headrom" style = "height:100px;">
                <!-- <nav class="navbar navbar-dark">-->
                    <div class="container">
                        ...
                        <div class="collapse navbar-toggleable-md" style="margin-left: 500px; padding: 50px; width : -400px;" id="mainNavbarCollapse">
                            <ul class="nav navbar-nav" style="width:850px;">
                                <li class="nav-item" color=> <a  class="nav-link active" href="index.php" >Home <span class="sr-only">(current)</span></a> </li>&nbsp;
                                <li class="nav-item" style="margin-top:-15px;">
                                <div class="dropdown">
                                <!-- <li class="nav-item" color=> -->
                                <button class="nav-link " style=" background:#000000; border:none; margin: top -25px;">Pages</button>
                            ...
                            if(empty($_SESSION["user_id"])) // if user is not login
                                ...
                                echo '<li class = "nav-item"><a href="cart.php" class="fafa"><i class="fa fa-shopping-cart" style=" font-size:24px; color:#ffffff"></i></a> </li>
                                        <li class = "nav-item"><a href="" class="fafa"><i class="fas fa-user-circle" style=" font-size:24px; color:#ffffff"></i></a> </li>';
                                }
                            else
                                {

                                        
                                        echo  ' <li class="nav-item" style="margin-top:-15px;">
                                        <div class="dropdown">
                                        <!-- <li class="nav-item" color=> -->
                                        <button class="nav-link " style=" background:#000000; border:none; margin: top -25px;">Order History</button>
                                            <div class="dropdown-content">
                                        ...
                                        <li class = "nav-item"><a href="cart.php" class="fafa"><i  class="fa fa-shopping-cart" style=" font-size:24px; color:#ffffff"></i><span class="badge"><?php echo get_cart_item_count(); ?></span></a> </li>
                                        <li class = "nav-item"><a href="profile.php" class="fafa"><i  class="fas fa-user-circle" style=" font-size:24px; color:#ffffff"></i></a> </li>
                                        <li class = "nav-item"><a href="logout.php" class="fafa"><i class="fa fa-sign-out" style=" font-size:24px; color:#ffffff"></i></a> </li>';
                                        
                                }
                                // href="logout.php" <li class="nav-item"><a href="your_orders.php" class="nav-link active">Your Orders</a> </li>
                            ?>
            ...
            <section class="hero bg-image" data-image-src="images/img/main.png" style="height: 800px ;">
                <div class="hero-inner">
                    <div class="container text-center hero-text font-white">
                        <!-- <h1>Order Delivery & Take-Out </h1> -->
                        <!-- "C:\xampp\htdocs\ofos\images\New Images\page bg.png" -->
            ...
            <section class="popular" style="background : #ffffff;">
                <div class="container">
                    <div class="title text-xs-center m-b-30">
                        <h2 style="font-family:cursive;">Popular Dishes of the Month</h2>
                        <p  style="font-family:cursive;" class="lead">The easiest way to your favourite food</p>
                    </div>
                    <div class="row">
                            <?php 					
                                    ...
                                    while($r=mysqli_fetch_array($query_res))
                                    {
                                        ...
                                        echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                                <div class="food-item-wrap">
                                                    <div class="figure-wrap bg-image" href="dishes.php?res_id='.$r['rs_id'].'" data-image-src="restaurant/Res_img/dishes/'.$r['img'].'"></div>
                                                    <div class="content" >
                                                        <h5 style="text-align:center;" ><a href="dishes.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5><br>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="restaurants-filter pull-right">
                                ...
                                <ul>
                                    <div class="dropdown">
                                    <button class="dropbtn" Style="float:right;">Category</button>
                                        <div class="dropdown-content"><a href="#" class="selected" data-filter="*">All</a>									<?php 
                                        $res= mysqli_query($db,"select * from res_category");
                                            while($row=mysqli_fetch_array($res))
                                            {
                                                echo '<a href="#" data-filter=".'.$row['c_name'].'"> '.$row['c_name'].'</a>';
                                            }
                                        ?>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="restaurant-listing">
                            ...
                            <?php  
                            $ress= mysqli_query($db,"select * from restaurant LIMIT 6");  
                                                            ...
                                                            <div class="restaurant-wrap">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                                                        <h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span style="color:#000000;">'.$rows['address'].'</span>
                                                                    </div>
                    ...
                    <div class="bottom-footer">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4 address color-gray">
                                        <h5>Address</h5>
                                        <p>Mota Bazzar - Vallabh Vidya Nagar, Anand-388120 , India</p>
                                        <h5>Phone: +91 9998887776</a></h5> </div>
