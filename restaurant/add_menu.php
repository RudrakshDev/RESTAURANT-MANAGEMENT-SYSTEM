					...
					{        
									if($fsize>=100000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,title,slogan,price,img) VALUE('".$_SESSION['res_id']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Item to Sell</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <!-- <div class="row">
											 ...
											 <!-- <div class="col-md-12">
                                                <div class="form-group">
													...
													<input type="text" name="res_name" class="form-control" value="
                                                </div>
                                            </div>
