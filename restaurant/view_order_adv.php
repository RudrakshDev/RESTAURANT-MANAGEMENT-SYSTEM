                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">View Advance Order</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT users.*, adv_orders.* FROM users INNER JOIN adv_orders ON users.u_id=adv_orders.u_id where a_id='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update_adv.php?form_id=<?php echo htmlentities($rows['a_id']);?>');" title="Update order">
											...
											<tr>
												<td><strong>Title:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile_adv.php?newform_id=<?php echo htmlentities($rows['a_id']);?>');" title="Update order">
											...
											<tr>
													<td><strong>Date:</strong></td>
												     <td><center><?php echo $rows['adate']; ?></center></td>
													  
												   																							
											</tr>
                                            <tr>
													<td><strong>Time:</strong></td>
												     <td><center><?php echo $rows['atime']; ?></center></td>
