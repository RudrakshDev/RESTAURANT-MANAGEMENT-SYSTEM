...
{
    echo "Welcome to " .$row['title']. " Portal";
}?>
                    </a>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Advance Orders</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											<?php
												$sql = "SELECT users.*, adv_orders.* FROM users INNER JOIN adv_orders ON users.u_id=adv_orders.u_id WHERE adv_orders.rs_id='" . $_SESSION["res_id"] . "'";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																		   ...
																		   <?php 
																			...
																			?>
																						<?php																									
																							echo '	<td>'.$rows['adate'].'</td>';
                                                                                            echo '	<td>'.$rows['atime'].'</td>';
                                                                                           echo ' <td>₹'.$rows['price']*$rows['quantity'].'</td>';
																							?>
																									 <td>
																									 <a href="delete_adv_orders.php?order_del=<?php echo $rows['a_id'];?>" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
																								echo '<a href="view_order_adv.php?user_upd='.$rows['a_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td>
																									</tr>';
                        ...
                        <button class="btn btn-warning" style="background-color:#ffca93;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_all_advorders.php'">Export Data</button>
