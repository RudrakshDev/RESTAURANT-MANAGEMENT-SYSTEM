            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM dishes  where rs_id = ".$_SESSION["res_id"]."";
                        ...
                        <button class="btn btn-warning" style="background-color:#ffca93;color:#000000;border:none;margin-left:15px;margin-top:15px;font-size:15px;" type="button" onclick="location.href='export_all_menu.php'">Export Data</button>
