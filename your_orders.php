...
<body>
  ...
  <thead>
    <tr>
      <th style="text-align:center; background :rgb(210,232,241); Color:#000000;">Order No.</th>
  ...
  <tbody>
    <?php
    $query_res = mysqli_query($db, "SELECT o.*, r.title AS restaurant_name FROM users_orders o INNER JOIN restaurant r ON o.rs_id = r.rs_id WHERE o.u_id='" . $_SESSION['user_id'] . "'");
